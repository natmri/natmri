 ...
 * .e.g.
 * ```txt
 *  wsc://$DEFAULT/wallpaper-name/project.json
 * ```
 * if e:// exist, $DEFAULT equivalent to e://natmri-store,
 * wsc://$DEFAULT/wallpaper-name/project.json to fs path,
 * equivalent to e://natmri-store/wallpaper-name/project.json.
 *
 * ```ts
